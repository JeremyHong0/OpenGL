...
int SimpleScene::Init()
{
    ...
    main_shader_->loadShader("shader/phongShading.vert",
        "shader/phongShading.frag");
    draw_normal_shader_->loadShader("shader/normalShader.vert",
        "shader/normalShader.frag");
    light_sphere_shader_->loadShader("shader/lightSphere.vert",
