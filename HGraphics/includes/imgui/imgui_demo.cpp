...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Combo"))
    {
        ...
        // Label to preview before opening the combo (technically it could be anything)
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        const ImU32 u32_zero = 0, u32_one = 1, u32_fifty = 50, u32_min = 0, u32_max = UINT_MAX / 2, u32_hi_a = UINT_MAX
                        / 2 - 100, u32_hi_b = UINT_MAX / 2;
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            ImGuiWindowFlags child_flags = ImGuiWindowFlags_HorizontalScrollbar | (enable_extra_decorations
    ...
    struct MyItem
    {
        ...
        static int IMGUI_CDECL CompareWithSortSpecs(const void* lhs, const void* rhs)
        {
            ...
            for (int n = 0; n < s_current_sort_specs->SpecsCount; n++)
            {
                ...
                {
                case MyItemColumnID_ID: delta = (a->ID - b->ID);
                    break;
                case MyItemColumnID_Name: delta = (strcmp(a->Name, b->Name));
                    break;
                case MyItemColumnID_Quantity: delta = (a->Quantity - b->Quantity);
                    break;
                case MyItemColumnID_Description: delta = (strcmp(a->Name, b->Name));
                    break;
                default: IM_ASSERT(0);
                    break;
                }
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Sizing policies"))
    {
        ...
        static ImGuiTableFlags flags = ImGuiTableFlags_ScrollY | ImGuiTableFlags_Borders | ImGuiTableFlags_RowBg |
        ...
        if (ImGui::BeginTable("table2", column_count, flags, ImVec2(0.0f, TEXT_BASE_HEIGHT * 7)))
        {
            for (int cell = 0; cell < 10 * column_count; cell++)
            {
                ...
                {
                case CT_ShortText: ImGui::TextUnformatted(label);
                    break;
                case CT_LongText: ImGui::Text("Some %s text %d,%d\nOver two lines..", column == 0 ? "long" : "longeeer",
                                              column, row);
                    break;
                case CT_ShowWidth: ImGui::Text("W: %.1f", ImGui::GetContentRegionAvail().x);
                    break;
                case CT_Button: ImGui::Button(label);
                    break;
                case CT_FillButton: ImGui::Button(label, ImVec2(-FLT_MIN, 0.0f));
                    break;
                case CT_InputText: ImGui::SetNextItemWidth(-FLT_MIN);
    ...
    if (ImGui::TreeNode("Outer size"))
    {
        ...
        static ImGuiTableFlags flags = ImGuiTableFlags_Borders | ImGuiTableFlags_Resizable |
            ImGuiTableFlags_ContextMenuInBody | ImGuiTableFlags_RowBg | ImGuiTableFlags_SizingFixedFit |
    ...
    if (ImGui::TreeNode("Custom headers"))
    {
                              ...
                              ImGuiTableFlags_Borders | ImGuiTableFlags_Reorderable | ImGuiTableFlags_Hideable))
        {
            ...
            for (int column = 0; column < COLUMNS_COUNT; column++)
            {
                ...
                // Retrieve name passed to TableSetupColumn()
                ImGui::PushID(column);
                ImGui::PushStyleVar(ImGuiStyleVar_FramePadding, ImVec2(0, 0));
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        static ImGuiTableFlags flags1 = ImGuiTableFlags_Resizable | ImGuiTableFlags_Reorderable |
            ImGuiTableFlags_Hideable | ImGuiTableFlags_Borders | ImGuiTableFlags_ContextMenuInBody;
    ...
    if (ImGui::TreeNode("Advanced"))
    {
                              ...
                              inner_width_to_use))
        {
            ...
            // This is so our sort function can identify a column given our own identifier. We could also identify them based on their index!
            ImGui::TableSetupColumn(
                "ID", ImGuiTableColumnFlags_DefaultSort | ImGuiTableColumnFlags_WidthFixed |
        ...
        if (ImGui::BeginTabItem("Rendering"))
        {
            ...
            if (ImGui::IsItemActive())
            {
                ...
                for (int n = 0; n < 7; n++)
                {
                    ...
                    draw_list->AddCircle(ImVec2(p.x + off_x + rad, p.y + RAD_MAX), rad,
